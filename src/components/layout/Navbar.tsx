    ...
    <>
      ...
      {mobileOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={label('Navigation menu', 'قائمة التنقل')}
          className="fixed inset-0 z-[900] bg-cream dark:bg-[#0E0904] flex flex-col"
        >
          <div className="flex justify-between items-center px-6 py-5 border-b border-sand">
            ...
            <button
              ...
              className="text-2xl p-1 hover:text-gold transition-colors"
              aria-label={label('Close menu', 'إغلاق القائمة')}
            >✕</button>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 h-[68px] flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            <button
              ...
              aria-label={mobileOpen ? label('Close menu', 'إغلاق القائمة') : label('Open menu', 'فتح القائمة')}

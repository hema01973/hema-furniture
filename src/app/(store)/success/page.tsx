...
export default function SuccessPage() {
  ...
  // HIGH-01 FIX: validate order number against expected HEM-YYYY-NNNNN format
  // before rendering. Unvalidated URL params could carry phishing payloads
  // (fake status messages, unicode overrides, homograph attacks).
  // If format does not match, fall back to generic confirmation —
  // the legitimate Paymob callback always emits a well-formed order number.
